...
export default async function EnglishFaithLessonPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    // Get related lessons
    const allLessons = await getLessonsByCategory("faith", "en")
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-6">
                <div className="container mx-auto px-4">
                    <nav className="flex items-center gap-2 text-sm mb-4">
                        ...
                        <ChevronRight className="h-4 w-4" />
                        <Link href="/eng/categories/faith" className="hover:underline opacity-80">Principles of Faith</Link>
                        <ChevronRight className="h-4 w-4" />
                        <span className="text-blue-200">Lesson</span>
                    </nav>
                </div>
            </div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mt-16 pt-8 border-t">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {prevLesson && (
                                <Link
                                    href={`/eng/categories/faith/lessons/${prevLesson.slug}`}
                            ...
                            {nextLesson && (
                                <Link
                                    href={`/eng/categories/faith/lessons/${nextLesson.slug}`}
                    ...
                    <div className="mt-12 bg-blue-50 border border-blue-200 rounded-xl p-8 text-center">
                        ...
                        <Button asChild size="lg">
                            <Link href="/eng/categories/faith">
                                View All Lessons
                            </Link>
                        </Button>
                    </div>
