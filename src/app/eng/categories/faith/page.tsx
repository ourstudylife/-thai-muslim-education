...
export default async function EnglishFaithPage() {
        ...
        <div className="min-h-screen bg-gradient-to-b from-background via-blue-50/30 to-background">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-8">
                <div className="container mx-auto px-4">
                    ...
                    <h1 className="font-serif text-4xl md:text-5xl font-bold mb-4">Principles of Faith</h1>
                    <p className="text-xl text-blue-100 max-w-3xl">
                        Step-by-step learning path for Islamic beliefs and core principles.
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-16">
                <div className="max-w-4xl mx-auto">
                                    ...
                                    >
                                        ...
                                        <div className="bg-card border rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300 group-hover:translate-x-2">
                                            ...
                                            <Button asChild className="w-full sm:w-auto" variant="outline">
                                                <Link href={`/eng/categories/faith/lessons/${lesson.slug}`}>
                                                    Start Learning
                                                </Link>
                                            </Button>
                                        </div>
                    ...
                    {/* Completion Card */}
                    {lessons.length > 0 && (
                        <div className="mt-16 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl p-8 text-center">
