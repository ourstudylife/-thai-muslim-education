...
export default async function PracticeLessonPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const lesson = await getLessonBySlug(slug, "practice-lessons")
    ...
    // Get related lessons
    const allLessons = await getLessonsByCategory("practice-lessons")
            ...
            <div className="bg-gradient-to-r from-green-600 to-emerald-700 text-white py-6">
                <div className="container mx-auto px-4">
                    <nav className="flex items-center gap-2 text-sm mb-4">
                        ...
                        <ChevronRight className="h-4 w-4" />
                        <Link href="/categories/practice" className="hover:underline opacity-80">หลักการปฏิบัติ</Link>
                        <ChevronRight className="h-4 w-4" />
                        <span className="text-green-200">บทเรียน</span>
                    </nav>
                </div>
            </div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mt-16 pt-8 border-t">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {prevLesson && (
                                <Link
                                    href={`/categories/practice/lessons/${prevLesson.slug}`}
                            ...
                            {nextLesson && (
                                <Link
                                    href={`/categories/practice/lessons/${nextLesson.slug}`}
